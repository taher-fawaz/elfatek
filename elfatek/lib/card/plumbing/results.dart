      ...
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              _buildResultsRow('Name', model.title),
              _buildResultsRow('Type', model.cityLabel),
              _buildResultsRow('Gender', model.currentMainGroup),
              ...
              _buildResultsRow('Style', model.currentSecondGroupItem),
